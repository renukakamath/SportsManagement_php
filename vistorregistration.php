...
if (isset($_POST['cusreg'])) {
    ...
    echo$q="insert into login values(null,'$uname','$pwd','vistors')";
     $id=insert($q);
 echo $q1="insert into vistors values(null,'$id','$fname','$lname','$num','$place','$email') ";
   insert($q1);
   alert('sucessfully');
   return redirect('vistorregistration.php');
}
}
...
<center>
<h1  style="color: white">Vistorss Registration</h1>
<form method="post" style="" class="ppp">
	<table class="table" style="width:500px;color: ">
		...
		<tr>
			<th>Last Name</th>
			<td><input type="text" required="" class="form-control" style="color: " name="lname"></td>
		</tr>
